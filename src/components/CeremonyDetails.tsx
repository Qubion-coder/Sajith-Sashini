              ...
              <div className="relative group">
                ...
                <div>
                  ...
                  <div className="space-y-1.5 text-stone-500/90 font-serif text-base sm:text-lg">
                    <p>
                      <span className="font-semibold text-stone-700">Time:</span> 10.15 AM Onwards
                    </p>
                    <p className="leading-relaxed">
                      <span className="font-semibold text-stone-700">Venue:</span> The Epitome Hotel,<br className="hidden sm:block" /> Kurunegala
                    </p>
                  </div>
                </div>
              </div>
